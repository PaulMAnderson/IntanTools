function filteredData = CAR_HP_OE(OEHeaderPath, runFilter)
...
%
% Will then write out this data to a .dat file that Neuroscope can read
% The same directory should contain the '.continuous' files that are the
% raw data
...
if nargin > 0
    [fileParts, ~] = strsplit(OEHeaderPath,filesep);
    file = fileParts{end};
